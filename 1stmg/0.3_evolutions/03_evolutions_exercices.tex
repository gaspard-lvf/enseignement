...
\begin{exo}[Vrai-faux][]
    \begin{enumerate}
        \item Un article subit une baisse de 20\% suivie d'une seconde baisse de 10\%. Quel est le taux d'évolution global du prix de cet article ?
        \item Un prix augmente de 20\% puis baisse de 30\%. Quelle est l'évolution globale de ce prix ?
        \item Un prix a été diminué de 40\% puis augmente de 10\%. Quelle est l'évolution globale de ce prix ?
    \end{enumerate}
\end{exo}
