...
\prof{
    Pour motiver le chapitre, utiliser \(\dfrac{16}{20}\) et \(\dfrac{12}{16}\)
}

\section{Rappels sur les proportion et les pourcentages}

\begin{exo}[][]
À l'aide des tableaux de proportionalité suivants, comparer \(\dfrac{9}{25}\) et \(\dfrac{6}{15}\)
...
\begin{enumerate}
    ...
    \medbreak
    \item Quelle est la proportion (ou fréquence) d'élèves de seconde ?
    \item Quelle est la proportion d'élèves qui sont en première et font LV2 italien ?
    \medbreak
...
\begin{enumerate}
    ...
    \begin{enumerate}
        ...
        \item La proportion de médailles d'or obtenues par les Etats-Unis parmi l'ensemble des médailles.
        \item La proportion de médailles obtenues par la France.
        \item La proportion de médailles qui sont en bronze et obtenues par le Japon.
        \item La proportion de médailles obtenues par la Chine parmi toutes les médailles d'or.
        \item La proportion de médailles de bronze parmi toutes les médailles obtenues par la France.
