...
\(f\) a pour coefficient directeur \(a=2>0\) : \(f\) est croissante. Son zéro :
\[
f(x)=0 \iff 2x-3=0 \iff 2x=3 \iff x=\frac{3}{2}.
\]
\(g\) a pour coefficient directeur \(a=-1<0\) : \(g\) est décroissante. Son zéro :
\[
g(x)=0 \iff -x+4=0 \iff -x=-4 \iff x=4.
\]
...
\(f\) a pour coefficient directeur \(a=-3<0\) : \(f\) est décroissante. Son zéro :
\[
f(x)=0 \iff -3x+6=0 \iff -3x=-6 \iff x=2.
\]
\(g\) a pour coefficient directeur \(a=1>0\) : \(g\) est croissante. Son zéro :
\[
g(x)=0 \iff x+1=0 \iff x=-1.
\]
...
\(f\) a pour coefficient directeur \(a=4>0\) : \(f\) est croissante. Son zéro :
\[
f(x)=0 \iff 4x-2=0 \iff 4x=2 \iff x=\frac{1}{2}.
\]
\(g\) a pour coefficient directeur \(a=-2<0\) : \(g\) est décroissante. Son zéro :
\[
g(x)=0 \iff -2x-4=0 \iff -2x=4 \iff x=-2.
\]
...
\(f\) a pour coefficient directeur \(a=-1<0\) : \(f\) est décroissante. Son zéro :
\[
f(x)=0 \iff -x+3=0 \iff -x=-3 \iff x=3.
\]
\(g\) a pour coefficient directeur \(a=3>0\) : \(g\) est croissante. Son zéro :
\[
g(x)=0 \iff 3x+6=0 \iff 3x=-6 \iff x=-2.
\]
