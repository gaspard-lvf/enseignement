...
\begin{itemize}
    ...
    \item Résoudre une équation du premier degré une équation produit nul.
...
\begin{exo}[Rappels][]
On considère la fonction affine définie sur \(\mathbb{R}\) \(f(x)=2x+1\).
...
\begin{center}
\begin{tikzpicture}
\tkzTabInit[lgt=1.1,espcl=1.3]{\(x\) /1, \(f\) /2}{\(-4\),\(0\),\(3\),\(5\)}
\tkzTabVar{+/\(4\),-/\(-2\),+/\(6\),-/\(2\)}
\end{tikzpicture}
\end{center}
