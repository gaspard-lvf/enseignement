...
\begin{exo}[Rappels][]
On considère la fonction \(f\) définie sur \(\mathbb{R}\) par \(f(x)=(2x-3)(x+1)\). On remarque que cette fonction est le produit des deux fonctions affines \(u(x)=2x-3\) et \(v(x)=x+1\).
