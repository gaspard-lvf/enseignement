...
{\color{red}\begin{itemize}
    ...
    \item Pendant la phase de correction, détailler très clairement les deux méthodes. C'est un exemple du cours. Ils doivent savoir utiliser les deux pour les exerices suivants.
    ...
    \item Pour les variables didactiques : On commence qu'avec des nombres positifs. $f(x) = 2x+1$ donne $x=-\frac{1}{2}$. Cela permet de revoir la valeur décimal de $\frac{1}{2}$.
\end{itemize}}
}
...
\prof{
{\color{red} \begin{itemize}
    \item Solutions des équation permettent de revoir les valeurs des fractions de références.
