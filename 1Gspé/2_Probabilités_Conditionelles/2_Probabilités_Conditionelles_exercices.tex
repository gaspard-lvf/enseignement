...
\begin{exo}[Univers, évènements et loi équirépartie][]
On lance un dé équilibré à 8 faces, numérotées de 1 à 8, et on note le numéro obtenu.

On considère les évènements :
\begin{itemize}
    \item \(A\) : \og le numéro obtenu est un multiple de 3 \fg{} ;
    \item \(B\) : \og le numéro obtenu est pair \fg{}.
\end{itemize}

\begin{enumerate}[leftmargin=*]
    \item Donner l'univers \(\Omega\) de cette expérience et sa loi de probabilité. Justifier.
    \item Donner les évènements \(A\) et \(B\) en extension (liste de leurs éléments), puis calculer \(P(A)\) et \(P(B)\).
    \item Décrire par une phrase, puis en extension, les évènements \(A\cap B\) et \(A\cup B\). Calculer leurs probabilités.
    \item Décrire l'évènement contraire \(\overline{A}\) et calculer \(P(\overline{A})\).
\end{enumerate}
\end{exo}
...
\begin{enumerate}[leftmargin=*]
    ...
    \item Donner \(C\) et \(D\) en extension, puis calculer \(P(C)\) et \(P(D)\).
    \item Donner \(C\cap D\) et \(C\cup D\) en extension. Calculer \(P(C\cup D)\) de deux façons différentes : directement, puis à l'aide de la formule \(P(C\cup D)=P(C)+P(D)-P(C\cap D)\).
