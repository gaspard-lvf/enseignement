...
\begin{enumerate}[leftmargin=*]
    ...
    \item Calculer \(P(E)\).
    \item Calculer la probabilité que l'élève choisi soit en seconde 3 \textbf{et} fasse de l'allemand, c'est-à-dire  \mbox{\(P(S_3\cap A)\)}.
...
\begin{itemize}
    ...
    \item Chez les ados (\(45\%\)) pratiquent la natation.
    \item Chez les adultes, il y a deux cinquièmes de nageurs.
\end{itemize}
