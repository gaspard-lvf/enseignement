...
\begin{enumerate}[leftmargin=*]
    ...
    \item La suite définie par \(v_0 = 1\) et \(v_{n+1} = v_n^2\) est définie de façon explicite.
\end{enumerate}
\end{exo}
...
\begin{itemize}
    ...
    \item 5. Faux : \(v_{n+1}\) est donné en fonction de \(v_n\), c'est une définition par récurrence.
\end{itemize}
}
