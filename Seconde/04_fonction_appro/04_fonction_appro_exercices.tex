...
\section{Rappels}
\begin{exo}[][]
    Quelle est l'image de 0 par la fonction \(f\) définie par \(f(x)=x^2-3x+4\) ; où \(x\) représente un nombre quelconque dans l'intervalle \([-1\ ;\ 4]\)
\end{exo}

\begin{exo}[][]
    On considère la même fonction \(f\) définie par \(f(x) = x^2-3x+4\).
    \begin{enumerate}
        \item Compléter le tableau de valeurs suivant, pour \(x\) appartenant à l'intervalle \([-1\ ;\ 4]\).

        \renewcommand{\arraystretch}{2}
        \begin{tabular}{|*{8}{c|}}
            \hline
            \(x\) & \(-1\) & \(0\) & \(1\) & \(\dfrac{3}{2}\) & \(2\) & \(3\) & \(4\) \\
            \hline
            \(f(x)\) & & & & & & & \\
            \hline
        \end{tabular}

        \item Dans le repère ci-dessous, tracer la courbe représentative de \(f\) sur l'intervalle \([-1\ ;\ 4]\).
...
\end{exo}
\begin{exo}[][]
    On considère une fonction \(f\) définie sur l'ensemble \(\mathcal{D}_f = [-2;4]\) par le tableau de valeurs suivant :
    ...
    \begin{tabular}{|*{8}{c|}}
        ...
        \(x\) & \(-2\) & \(-1\) & \(0\) & \(1\) & \(2\) & \(3\) & \(4\) \\
        \hline
        \(f(x)\) & \(\dfrac{3}{2}\) & \(3\) & \(\dfrac{1}{2}\) & \(3\) & \(-1\) & \(4\) & \(0\) \\
        \hline
    \end{tabular}
    ...
    \begin{enumerate}
        ...
        \item Donner \(f(-2)\).
        \item Donner un antécédent de \(3\) par \(f\).
        \item Le nombre \(-1\) a-t-il un antécédent par \(f\) ? Si oui, lequel ?
...
\begin{enumerate}[leftmargin=*]
    ...
    \item Donner les éventuels antécédents de \(-1\) et de \(0\).
    \item Résoudre \(f(x)=1\).
\end{enumerate}
\end{exo}

\begin{exo}[][]
    On considère une fonction \(f\) définie sur l'intervalle \([-3;3]\) dont la représentation graphique est donnée ci-dessous.
...
node[pos=0.95, above right] {\(\mathcal{C}_f\)};
...
\medbreak
Quatre élèves proposent une représentation graphique de \(f\). Laquelle de ces courbes vous semble la plus satisfaisante ? Justifier.
...
\begin{tasks}(2)
    ...
    \addplot[smooth, blue, thick] coordinates {(-2.3,0.2)(-2,-1)(-1.5,-3)(-1,-1)(-0.5,3)(0,2)(0.5,0)(1,2)(1.5,1)(2,3)(2.3,4.2)};
    \addplot[only marks, mark=*, mark size=1pt, blue] coordinates {(-2,-1)(-1.5,-3)(-1,-1)(-0.5,3)(0,2)(0.5,0)(1,2)(1.5,1)(2,3)};
    \end{axis}
    \end{tikzpicture}
    ...
    \addplot[smooth, blue, thick] coordinates {(-2,-1)(-1.5,-3)(-1,-1)(-0.5,3)(0,2)(0.5,0)(1,2)(1.5,1)(2,3)};
    \addplot[only marks, mark=*, mark size=1pt, blue] coordinates {(-2,-1)(-1.5,-3)(-1,-1)(-0.5,3)(0,2)(0.5,0)(1,2)(1.5,1)(2,3)};
    \end{axis}
    \end{tikzpicture}
    ...
    \addplot[smooth, blue, thick] coordinates {(-2,-1)(-1.5,-3)(-1,-1)(-0.5,3)(0,2)(0.5,0)(1.5,1)(1,2)(2,3)};
    \addplot[only marks, mark=*, mark size=1pt, blue] coordinates {(-2,-1)(-1.5,-3)(-1,-1)(-0.5,3)(0,2)(0.5,0)(1.5,1)(1,2)(2,3)};
    \end{axis}
    \end{tikzpicture}
\end{tasks}
\end{exo}
...
\includegraphics[width=0.2\textwidth]{cone.png}
    ...
    \begin{enumerate}
        ...
        \item Résoudre graphiquement l'équation \\ \(V(x)=200\).\\ Reformuler votre réponse en utilisant : 
        \begin{tasks}
            \task le mot antécédent.
            \task le contexte de l'exercice. 
        \end{tasks}
    \end{enumerate}
