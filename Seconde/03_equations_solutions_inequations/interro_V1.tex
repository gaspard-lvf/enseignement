...
On considère l'inéquation \((I)\) : \(-2 \leqslant x < 5\).
...
On considère l'inéquation \((I)\) : \(-5 < x \leqslant 1\).
...
On considère l'inéquation \((I)\) : \(-1 \leqslant x < 3\).
...
On considère l'inéquation \((I)\) : \(-4 < x \leqslant 2\).
