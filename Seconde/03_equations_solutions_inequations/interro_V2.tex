...
\[
-1 \qquad \dfrac{1}{2} \qquad -\dfrac{7}{4}
\]
...
On considère l'inéquation \((I)\) : \(-3 \leqslant x < 2\).
...
On considère l'inéquation \((I)\) : \(-1 < x \leqslant 4\).
...
On considère l'inéquation \((I)\) : \(-4 \leqslant x < 0\).
...
Sur l'axe gradué ci-dessous, seuls les nombres \(0\) et \(1\) sont indiqués. Placer les nombres suivants :
\[
2 \qquad \dfrac{3}{2} \qquad -\dfrac{1}{4}
\]
...
On considère l'inéquation \((I)\) : \(-2 < x \leqslant 3\).
